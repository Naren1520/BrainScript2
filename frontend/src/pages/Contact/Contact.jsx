...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
      <Helmet>
        <title>Contact Us - BrainScript</title>
        <meta
          name="description"
          content="Get in touch with BrainScript. Connect with us on social media or send us a message."
        />
        <link rel="canonical" href="https://BrainScript.netlify.app/contact" />
      </Helmet>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.instagram.com/naren_s.j._"
                  target="_blank"
                  rel="noopener noreferrer"
