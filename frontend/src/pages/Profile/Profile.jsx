...
import { Edit2, Save, X, User, Mail, Camera, Upload } from "lucide-react";
...
export default function Profile() {
  ...
  const getImageUrl = (imagePath) => {
    if (!imagePath) return user?.picture || "https://www.gravatar.com/avatar/?d=mp";
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      // Convert preview to file if needed
      ...
      const res = await fetch(`${BASE_URL}/api/user/upload-profile-image`, {
        method: "POST",
        body: formData,
        credentials: "include",
      });
      ...
      if (res.ok) {
        ...
        // Refresh user data from auth endpoint to update context
        setTimeout(() => {
          window.location.reload();
        }, 1500);
      } else {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-blue-700 mb-3">
                      Review your new profile image before uploading
                    </p>
